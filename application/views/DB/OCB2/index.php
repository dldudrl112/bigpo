...
<body>
	<div class="sect_1">
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<img src="/assets/images/DB/OCB2/main.jpg" alt="메인이미지">
			</div>
		</div>
	</div>
	<div class="sect_2">
			...
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<div class="video-bg add_bg_01">
					<div class="video-container">
						<iframe width="100%" src="https://www.youtube.com/embed/BUQih8NtXRI" frameborder="0"></iframe>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<div class="get_area_m">
					<button id="button" class="cuckoo_01" onclick="location.href='tel:080-855-1003'">
	...
	<div id="list" name="list" class="sect_3 mobile1">
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<div id="list" style="margin: 20px;">
					<button id="button" class="cuckoo" onclick="location.href='tel:080-855-1003'">
		...
		<div id="pop">
			<article>
				...
				<div class="infoDetail">
					...
					<p><strong>[ 080-855-1003 ]</strong>으로 지금바로 전화주세요.</p><br>
		...
		<footer>
			<div class="container">
				<div class="col-sm-offset-3 col-sm-6 col-xs-12">
					<img src="/assets/images/DB/OCB2/footer.jpg" alt="푸터이미지">
				</div>
			</div>
		</footer>
</body>
